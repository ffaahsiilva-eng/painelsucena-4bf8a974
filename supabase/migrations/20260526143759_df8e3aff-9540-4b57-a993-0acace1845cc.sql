...
BEGIN
  ...
  -- DEDUP REFORÇADO: qualquer mensagem com mesmo status (label) deste equipamento
  -- nas últimas 6h em qualquer estado (pending/processing/sent) bloqueia o reenvio.
