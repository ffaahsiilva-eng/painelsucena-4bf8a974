...
BEGIN
  ...
  -- Sem status (NULL/none): seleção de veículo sem início de turno — não notifica
...
-- Limpa status atual de equipamentos que estão em "waiting" sem turno iniciado
UPDATE public.equipment
SET stop_reason = NULL, stop_start_time = NULL
WHERE stop_reason = 'waiting';